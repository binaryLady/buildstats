...
//        height = 900,
    ...
    function instructions() {
        textBox
            .append("g").append("text").text("This is a drillable barchart showing the successful/fail percentages for tests run with a three date comparison." +
    ...
    function makeBars(thisData, action, key) {
        ...
        bars
            ...
            .on("mouseover", function (d) {
                ...
                tiper
                    ...
                    .duration(200)
                    .style("opacity", .9)
                tiper.html('<p> Successful Tests: ' +  formatter(d.value.pass) +'</p>')
        ...
        bars
            ...
            .on("mouseover", function (d) {
                ...
                tiper
                    ...
                    .duration(200)
                    .style("opacity", .9)
                tiper.html('<p> Failed Tests: ' +  formatter(d.value.fail) +'</p>')
                    .style("left", (d3.event.pageX) + "px")
                    .style("top", (d3.event.pageY - 28) + "px");
            })
            .on("mouseout", hideTip)
        ...
        test.forEach(function (d) {
            d.value.pass = d.value.pass / d.value.total;
            d.value.fail = d.value.fail / d.value.total;
            d.value.total = d.value.fail + d.value.pass;
        })


        svg.append("g").append("text").text("Test Success Percentage" ).attr("class", "group");
